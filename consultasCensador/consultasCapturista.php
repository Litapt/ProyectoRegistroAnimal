...
if (!in_array($tabActiva, ['duenos', 'animales'])) {
    $tabActiva = 'duenos';
}
...
<header class="p-3 PPHeader text-white d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex align-items-center gap-3">
        <a class="btn btn-sm btn-outline-light" href="../capturista/principalCensador.php">Regresar</a>
    </div>
</header>
                ...
                <div id="consulta-duenos" class="consulta-tabla <?= $tabActiva !== 'duenos' ? 'd-none' : '' ?>">
                    ...
                    <nav class="navbar bg-body-tertiary mb-3 rounded">
                        <div class="container-fluid">
                            <form class="d-flex w-100" role="search" action="consultasCapturista.php" method="GET">
                                ...
                                <?php if ($buscarDueno !== ''): ?>
                                    <a href="consultasCapturista.php?tab=duenos" class="btn btn-outline-secondary ms-2">Limpiar</a>
                                <?php endif; ?>
                            </form>
                        </div>
                    </nav>
                    ...
                    <nav class="navbar bg-body-tertiary mb-3 rounded">
                        <div class="container-fluid">
                            <form class="d-flex w-100" role="search" action="consultasCapturista.php" method="GET">
                                ...
                                <button class="btn btn-outline-primary" type="submit">Buscar</button>
                                <?php if ($buscarAnimal !== ''): ?>
                                    <a href="consultasCapturista.php?tab=animales" class="btn btn-outline-secondary ms-2">Limpiar</a>
                                <?php endif; ?>
                            </form>
                        </div>
                    </nav>
